        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Welcome to Rocket Content ("we," "our," or "us"). We are committed to protecting your privacy 
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">2. Information We Collect</h2>
            <h3 className="text-xl font-medium text-foreground mt-6 mb-3">2.1 Account Information</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              When you create an account, we collect your name, email address, and password. If you sign up 
              using a third-party service (like Google), we receive basic profile information from that provider.
            </p>
            
            <h3 className="text-xl font-medium text-foreground mt-6 mb-3">2.2 Content Data</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
              We process YouTube video URLs and transcripts that you submit for content generation. This includes 
              the video metadata, transcripts, and any generated content (threads, posts, blogs, images).
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              CVV, or other sensitive payment details on our servers. Stripe may share limited transaction 
              information with us, such as the last four digits of your card and billing address for record-keeping.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              features used, generation history, and technical data like browser type, device information, and IP address.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">3. How We Use Your Information</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">4. AI Processing</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Rocket Content uses artificial intelligence to analyze video content and generate text and images. 
              Your submitted content is processed by our AI systems and may be temporarily stored for processing purposes.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              We do not use your personal content to train our AI models without your explicit consent. 
              Generated content belongs to you and can be deleted from our systems upon request.
            </p>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">5. Data Sharing & Disclosure</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              We do not sell your personal information. We may share data with:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li><strong className="text-foreground">Service Providers:</strong> Stripe (payments), cloud hosting providers, and analytics services</li>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">6. Data Security</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-foreground border-b border-border pb-2 mb-4">9. Changes to This Policy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              <a href="mailto:privacy@rocketcontent.app" className="text-primary hover:underline">
